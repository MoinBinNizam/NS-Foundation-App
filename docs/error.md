...
[dotenv@17.3.1] injecting env (3) from .env -- tip: 🔐 prevent committing .env to code: https://dotenvx.com/precommit
C:\TechVelly\NS-FOUNDATION\backend\node_modules\@prisma\client\runtime\client.js:70
...
```
    ...
    at new t (C:\TechVelly\NS-FOUNDATION\backend\node_modules\@prisma\client\runtime\client.js:70:1527)
    at Object.<anonymous> (C:\TechVelly\NS-FOUNDATION\backend\src\controllers\exitLogController.js:4:16)
